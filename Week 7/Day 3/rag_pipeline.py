...
KB_FILES = {
    "locations": PROJECT_ROOT / "locations.csv",
    "amenities": PROJECT_ROOT / "amenities.csv",
    "schools": PROJECT_ROOT / "schools.csv",
    "hospitals": PROJECT_ROOT / "hospitals.csv",
    "developers": PROJECT_ROOT / "developers.csv",
    "payment_plans": PROJECT_ROOT / "payment_plans.csv",
    "faqs": PROJECT_ROOT / "faqs.csv",
}
